...
import { ShieldCheck, Search, CheckCircle2, FolderOpen, Loader2, X } from "lucide-react";
        ...
        <AppLayout>
            <div className="min-h-screen bg-grid px-6 py-14">
                ...
                <div className="max-w-2xl mx-auto relative z-10">
                    ...
                    >
                        {[
                            { id: "create", icon: <ShieldCheck size={18} />, label: "Create Certificate" },
                            { id: "verify", icon: <Search size={18} />, label: "Verify Hash" },
                        ].map((m) => (
                            <button
                                key={m.id}
                            ...
                            {!cert ? (
                                <>
                                    ...
                                    >
                                        ...
                                        <span className="flex items-center justify-center p-2">{selectedFile ? <CheckCircle2 size={40} color="#00E87A" /> : <FolderOpen size={40} color="#00FFD1" />}</span>
                                        {selectedFile ? (
                                    ...
                                    >
                                        ...
                                        ) : <><ShieldCheck size={18} className="inline mr-2" /> Generate Certificate</>}
                                    </button>
                                ...
                                <div className="animate-fade-in">
                                    <div className="text-center mb-6">
                                        <div className="flex justify-center mb-4"><CheckCircle2 size={48} color="#00E87A" /></div>
                    ...
                    {mode === "verify" && (
                        <div className="card p-8 rounded-2xl animate-fade-in">
                            ...
                            <button className="btn-primary w-full mt-4 py-3 flex items-center justify-center gap-2" onClick={handleVerify} disabled={!verifyInput.trim()} style={{ opacity: verifyInput.trim() ? 1 : 0.4 }}>
                                <Search size={18} /> Verify Hash
                            </button>
                            ...
                            {verifyResult && (
                                ...
                                >
                                    <span className="flex items-center justify-center p-2">{verifyResult === "valid" ? <CheckCircle2 size={56} color="#00E87A" /> : <X size={56} color="#FF4E6A" />}</span>
